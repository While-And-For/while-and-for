...
var InputNumber_1 = tslib_1.__importDefault(require("./InputNumber"));
...
var InputNumber = function (_a) {
    ...
    return (react_1.default.createElement(Item_1.default, { hasFeedback: validate, help: validate && touched && error, label: label, required: required, validateStatus: validate ? status : '' },
        react_1.default.createElement(InputNumber_1.default, { formatter: formatter, name: field.name, value: field.value, onChange: setFieldValue, parser: parser, placeholder: placeholder })));
};
